...
disp(['Modelo computacional da VBTP GUARANI atravessando obstáculo tipo onda senoidal, ' ...
...
% Parâmetros do perfil senoidal
frequencia = 0.1; % Frequência da onda senoidal em ciclos por metro
amplitude = 0.1; % Amplitude da onda senoidal em metros (altura máxima)

% Geração do perfil senoidal da estrada
h = amplitude * sin(2 * pi * frequencia * x);
